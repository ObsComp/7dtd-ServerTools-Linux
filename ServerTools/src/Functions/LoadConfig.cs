        ...
        public static void UpdateXml()
        {
            try
            {
                ...
                using (StreamWriter sw = new StreamWriter(configFilePath))
                {
                    ...
                    sw.WriteLine("    </Version>");
                    sw.WriteLine("    <Tools>");
                    sw.WriteLine(string.Format("        <Tool Name=\"DataBase\" ServerHost=\"{0}\" Port=\"{1}\" DatabaseName=\"{2}\" UserName=\"{3}\" Password=\"{4}\" />", MySqlDatabase.Server, MySqlDatabase.Port, MySqlDatabase.Database, MySqlDatabase.UserName, MySqlDatabase.Password));
